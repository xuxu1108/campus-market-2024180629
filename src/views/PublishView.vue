  ...
  <section class="page">
    ...
    <form class="publish-form" @submit.prevent="handleSubmit">
      ...
      <template v-if="publishType === 'lostFound'">
        ...
        <FormField label="发生时间" required :error="errors.lostFoundTime">
          <input v-model="form.lostFoundTime" type="datetime-local" />
        </FormField>

        <FormField label="联系方式" required>
          <input v-model.trim="form.contact" type="text" placeholder="如：站内消息联系" />
        </FormField>
      </template>
      ...
      <template v-if="publishType === 'errand'">
        ...
        <FormField label="取件地点" required :error="errors.pickupLocation">
          <input v-model.trim="form.pickupLocation" type="text" placeholder="请输入取件地点" />
        </FormField>

        <FormField label="送达地点" required :error="errors.deliveryLocation">
          <input v-model.trim="form.deliveryLocation" type="text" placeholder="请输入送达地点" />
        </FormField>
